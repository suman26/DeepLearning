...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier('D:\\Computer-Vision-with-Python\\FaceRecognition-master//HaarCascade//haarcascade_frontalface_default.xml')#Load haar classifier
